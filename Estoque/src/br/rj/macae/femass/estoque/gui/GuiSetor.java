...
import br.rj.macae.femass.estoque.controle.SetorControle;
 ...
 * @author jorge
 */
public class GuiSetor extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        tblSetores.setGridColor(new java.awt.Color(204, 204, 204));
        tblSetores.getTableHeader().setReorderingAllowed(false);
        jScrollPane1.setViewportView(tblSetores);
        if (tblSetores.getColumnModel().getColumnCount() > 0) {
    ...
    private void btnAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAlterarActionPerformed
        if(tblSetores.getSelectedRow()>=0){
            ...
            Object valor=((DefaultTableModel)tblSetores.getModel()).getValueAt(tblSetores.getSelectedRow(), 0);
            try {
                Setor c = controle.getSetorPorId((Integer) valor);
 ...
 private void limparCampos() {
    ...
    private void habilitarCampos() {
        ...
        tblSetores.setEnabled(false);
    }
    private void desabilitarCampos() {
        pNovo.setVisible(false);
        btnGravar.setVisible(false);     
        btnCancelar.setVisible(false);     
        tblSetores.setEnabled(true);
    ...
    private void atualizarLista(){
           SetorControle controle = new SetorControle();
        try {
            controle.atualizarLista(tblSetores);
        } catch (SQLException ex) {
            JOptionPane.showMessageDialog(this, ex.getMessage());
        }        
    }
